...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        elif hasattr(self.obj, message[len(magic_word):]):
            return getattr(self.obj, message[len(magic_word):])(*args)
        else:
            return 'Thanks for asking, but I know not how to ' + message[len(magic_word):] + '.'
