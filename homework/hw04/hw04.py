...
def count_change(amount):
    ...
    def count_n(amount, n):
        if n == 1:
            return 1
        if n > amount:
            return count_n(amount, n // 2)
        else:
            return count_n(amount, n//2) + count_n(amount - n, n)

    return count_n(amount, largest_coin(amount))
