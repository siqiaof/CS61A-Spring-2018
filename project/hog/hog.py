...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if (not is_swap(newscore, opponent_score)) and (free_bacon(opponent_score) >= margin):
        return 0
    elif is_swap(newscore, opponent_score) and (newscore < opponent_score):
        return 0 
    else:
        return num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if newscore > GOAL_SCORE:
        return 0    
    elif score + 10 > GOAL_SCORE:
        return 2
    elif is_swap(score + 1, opponent_score) and (score + 1 != opponent_score):
        if score + 1 < opponent_score:
            return 10
        else:
            return 1
    elif score > opponent_score:
        return 4
    elif is_swap(score + 1, opponent_score + 1) and (score + 1 != opponent_score + 1):
        return 10
    else:
        return swap_strategy(score, opponent_score, margin=12, num_rolls=8)
    # END PROBLEM 12
