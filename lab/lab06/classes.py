...
class Player(object):
    ...
    def go_to(self, location):
        ...
        elif destination_place == self.place:
            print('You are at', self.place.name)
        else:
    ...
    def take(self, thing):
        ...
        elif thing in self.place.things.keys():
    ...
    def unlock(self, place):
        ...
        elif self.place.get_neighbor(place).locked == False:
            print(place, 'is already unlocked!')
        else:
            key.use(place)
            self.place.get_neighbor(place).locked = False
