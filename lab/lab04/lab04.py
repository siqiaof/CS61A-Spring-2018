...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    latdis = get_lat(city1) - get_lat(city2)
    londis = get_lon(city1) - get_lon(city2)
    return ( latdis**2 + londis**2 ) ** 0.5
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    there = make_city('there', lat, lon)
    if distance(there, city1) <= distance(there, city2):
